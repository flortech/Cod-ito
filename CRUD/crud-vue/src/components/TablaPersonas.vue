...
export default {
    ...
    props: {
        personas: Array,
        actualizarComponente: Object,
        
  },

watch:{
  actualizarComponente(){
    if (this.actualizarComponente && this.actualizarComponente.actualizado){
...
methods: {
    ...
    eliminarPersona(id) {
        ...
        console.log(this.eliminarPersona, id);
        alert('la persona con id ' + id + ' fue eliminada');
    ...
    const personaEditadaID = this.idPersonaEditada;
    const datosEditados = { id: personaEditadaID, persona: persona };
    this.$emit('guardar-persona', datosEditados);
